...
import com.mz.acesaii.presentation.components.PokerEntryHolder
...
fun HomeScreenContent(
    ...
    pokerEntries: Map<LocalDate, List<Poker>>,
    onClick: (String) -> Unit,

)  {
    if (pokerEntries.isNotEmpty()) {
        LazyColumn(
            modifier = Modifier
            ...
            pokerEntries.forEach { (localDate, entries) ->
                ...
                items(
                    ...
                    PokerEntryHolder(poker = it, onClick = onClick)
                }
            }
        }
    } else {
